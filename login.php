...
<body>
    <div class="w-full h-full bg-bg">
        <div class=" w-full h-screen flex justify-center items-center">
            <div class="w-[28rem] p-5 bg-bg">
                ...
                <p class="text-text text-center">Yukk Login sekarang!</p>
                ...
                <div>
                    ...
                    <div>
                        <p class="text-center mt-3 text-text">Belum punya akun?<a href="register.php" class="text-blue-600">Register</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <p>&copy; Ujikom 2024 | Naila Fitri</p>
</body>
